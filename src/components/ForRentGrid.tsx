  ...
  return (
    <div style={{ background: '#f8fafc', minHeight: '100vh', fontFamily: BODY }}>
      ...
      <div style={{ position:'relative', height:isMobile?380:480, overflow:'hidden', marginTop:'-72px' }}>
        ...
        <img src="https://images.mlrecloud.com/site/el-cid-homes/hero.jpg" alt="El Cid homes for rent in West Palm Beach, Florida" style={{ width:'100%', height:'100%', objectFit:'cover', objectPosition:'center 35%' }} />
